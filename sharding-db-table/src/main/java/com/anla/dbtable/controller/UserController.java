...
public class UserController {
    ...
    private void getData() {
        ...
        userList.add(new User(1L,"小小1", "女", 13));
        userList.add(new User(2L,"爸爸2", "男", 130));
        userList.add(new User(3L,"妈妈3", "女", 128));
        userList.add(new User(4L,"爷爷4", "男", 164));
        userList.add(new User(5L,"奶奶5", "女", 162));
    }
    /**
     * @Description: 批量保存用户
     */
